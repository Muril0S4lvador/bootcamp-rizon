...
const botaoGetNomeFunc = document.getElementById(
  "get-nome-func"
) as HTMLButtonElement;
const botaoUpdNomeFunc = document.getElementById(
  "upd-nome-func"
) as HTMLButtonElement;
const botaoGetBioFunc = document.getElementById(
  "get-bio-func"
) as HTMLButtonElement;
const botaoUpdBioFunc = document.getElementById(
  "upd-bio-func"
) as HTMLButtonElement;
const botaoRemItemFunc = document.getElementById(
  "rem-item-func"
) as HTMLButtonElement;

const botaoGetNomeImp = document.getElementById(
  "get-nome-imp"
) as HTMLButtonElement;
const botaoUpdNomeImp = document.getElementById(
  "upd-nome-imp"
) as HTMLButtonElement;
const botaoGetBioImp = document.getElementById(
  "get-bio-imp"
) as HTMLButtonElement;
const botaoUpdBioImp = document.getElementById(
  "upd-bio-imp"
) as HTMLButtonElement;
const botaoRemItemImp = document.getElementById(
  "rem-item-imp"
) as HTMLButtonElement;
